...
export const SITE = {
  ...
  address: 'Ghoda Vistar, Dodikhad, Khanpur Road, Anand, Gujarat – 388365',
  city: 'Anand, Gujarat',
  msme: 'UDYAM-GJ-03-0037832',
  gstin: '24BPEPC4856G',
  mapEmbed: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d203.91767539356732!2d73.1156947644251!3d22.54495605187556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e355cd1987bd5%3A0x608ce43031379b5!2sD.ENERGY%20-%20Go%20Green%20With%20Solar%20Power!5e1!3m2!1sen!2sin!4v1775464198122!5m2!1sen!2sin',
  mapLink: 'https://maps.app.goo.gl/mNWktHVL3ACsfCn29',
  facebook: '#',
  instagram: '#',
  youtube: '#',
  hours: { weekday: '9:00 AM – 7:00 PM', sunday: '10:00 AM – 3:00 PM' },
};

export const SLIDES = [
  { tag: '⭐ Trusted Solar Partner', title: 'Go Green With', em: 'Solar Power', sub: 'Save up to 90% on electricity bills. Expert I&C installation for residential & commercial projects.', img: 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=1600&q=80', cta: 'Get Free Quote', ctaHref: '/contact' },
  { tag: '💰 Save Big Every Month', title: 'Cut Your Bill by', em: '₹3,000–₹8,000/month', sub: 'Government subsidy up to 40%. Payback in just 3–5 years.', img: 'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1600&q=80', cta: 'Calculate Savings', ctaHref: '/contact' },
  { tag: '✅ 500+ Projects Completed', title: 'Experts You Can', em: 'Trust in Gujarat', sub: 'Professional I&C installation. 10 years experience. Lifetime support.', img: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=1600&q=80', cta: 'See Our Work', ctaHref: '/projects' },
];

export const STATS = [
  { num: 500, unit: '+', label: 'Projects Completed' },
  { num: 200, unit: '+', label: 'Happy Customers' },
  { num: 10, unit: ' Yrs', label: 'Experience' },
...
export const WHY_US = [
  { icon: '🏆', title: 'Tier-1 Panels Only', desc: 'Waaree, Adani, Vikram, Tata — only BIS-certified, ALMM-listed panels.' },
  { icon: '📋', title: 'Subsidy Handled', desc: 'We manage all paperwork — DISCOM, PM Surya Ghar, PMKUSUM.' },
  { icon: '🛡️', title: '25-Year Warranty', desc: 'Panel + inverter + workmanship warranty coverage.' },
  { icon: '⚡', title: 'Fast Installation', desc: 'Most homes done in 1–3 days. Zero disruption, certified team.' },
];

export const STEPS = [
  { no: '1', title: 'Free Consultation', desc: 'Call or WhatsApp us. Our expert visits your site FREE.' },
  { no: '2', title: 'Custom Design', desc: 'We design the perfect system for your roof and needs.' },
  { no: '3', title: 'Subsidy & Approvals', desc: 'We handle DISCOM approval and government subsidy.' },
  { no: '4', title: 'Quick Installation', desc: 'Certified I&C team installs in 1–3 days. Clean & safe.' },
  { no: '5', title: 'Go Live + Support', desc: 'System on! We monitor & support you for life.' },
];
...
export const REVIEWS = [
  { name: 'Ghanshyam jadav Jadav', sub: '1 review · 1 photo', stars: 5, time: '8 months ago', text: 'Nice team solar service thank you for denergy' },
  { name: 'Hardik Solanki', sub: '1 review · 4 photos', stars: 5, time: 'Edited 8 months ago', text: 'Best solar installation work team' },
  { name: 'krishi prajapati', sub: '1 review', stars: 5, time: '6 months ago', text: 'Solar instolation proper fiting for d energy', img: '/reviews/krishi.png' },
  { name: 'Pratik Thakor', sub: '1 review', stars: 5, time: '8 months ago', text: 'Best price and service', img: '/reviews/pratik.png' },
  { name: 'Kamal Prajapati', sub: '1 review', stars: 5, time: '2 months ago', text: 'Good service 👍👍👍 ...', img: '/reviews/kamal.png' },
  { name: 'Manhar Parmar', sub: '1 review', stars: 5, time: '8 months ago', text: 'Finishing work ..✌️' },
  { name: 'Aslam khan Khan', sub: '1 review', stars: 5, time: '2 months ago', text: 'Very good fitting team...' },
...
export const FAQS = [
  ...
  { q: 'What government subsidy is available?', a: 'Under PM Surya Ghar Yojana: up to 40% subsidy for homes up to 2kW, 20% for 2–3kW. We handle the entire application at no extra cost.' },
  { q: 'What warranty do you provide?', a: '25-year panel performance warranty, 5-year inverter warranty, 10-year structure warranty, and 1-year free servicing post-installation.' },
  { q: 'Do solar panels work in monsoon?', a: 'Yes! Solar panels work on diffused sunlight. India\'s sunlight is adequate year-round to make solar highly effective even in monsoon.' },
];
...
export const CERTIFICATIONS = [
  { ico: '🏛️', title: 'MNRE', sub: 'Empaneled Installer' },
  { ico: '📋', title: 'MSME', sub: 'UDYAM-GJ-03-0037832' },
  { ico: '🧾', title: 'GST Registered', sub: '24BPEPC4856G' },
  { ico: '🏆', title: '10 Years', sub: 'Industry Experience' },
  // { ico: '⚡', title: 'DISCOM', sub: 'Approved Vendor' },
  // { ico: '☀️', title: 'Waaree Solar', sub: 'Authorized Partner' },
  // { ico: '⚡', title: 'Adani Solar', sub: 'Channel Partner' },
